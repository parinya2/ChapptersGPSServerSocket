...
//  2014/05/05 v2.5.5,  2014/06/29 v2.5.6,  2014/10/08 v2.5.7,
//  2015/02/12 v2.5.8
// ----------------------------------------------------------------------------
package org.opengts;
...
public class Version
{
    ...
    private static final String VERSION = "2.5.8"; // 2.5.8-B70 [2.5.7-B45]
    ...
    // last compile time
    private static final long COMPILE_TIMESTAMP = 999;

    // ------------------------------------------------------------------------

    // package release (modified by command-line 'sed' script to insert actual epoch time)
    private static final long PACKAGE_TIMESTAMP = 1423856379L;
