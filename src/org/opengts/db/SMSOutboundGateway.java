...
public abstract class SMSOutboundGateway
{
    ...
    /* Twilio (requires implementation) */
        ...
        /* HTTP: Custom */
        {
            ...
            if (!StringTools.isBlank(gwClassName)) {
                try {
                    ...
                    Print.logError("Unable to load '"+gwName+"' SMSOutboundGateway class: " + gwClassName);
                } catch (InstantiationException ie) {
                    Print.logError("Unable to instantiate '"+gwName+"' SMSOutboundGateway class: " + gwClassName);
                } catch (ClassCastException cce) {
                    Print.logError("Not a subclass of SMSOutboundGateway: " + gwClassName);
                } catch (Throwable th) {
                    Print.logError("Unable to create '"+gwName+"' SMSOutboundGateway class: " + gwClassName);
                }
            }
        }
    ...
    *** @param smsMessage The SMS message which to send to the phone number
