    ...
    implements UserInformation
{
    ...
    //   DemoAccount.demo.dateRange=2013/08/26,2013/08/26
    //   DemoAccount.demo2.dateRange=2013/08/26,2013/08/26
    ...
    private static String           DEFAULT_DEMO_DEVICE_DATE_RANGE[]    = new String[] { "2014/10/20", "2014/10/20" };
    // demo : 2014/10/20,13:05:37 to 2014/10/20,14:52:46
    // demo2: 2014/10/20,04:45:37 to 2014/10/20,11:35:18
            ...
            if (getTitle) {
                ...
                if (!acct.isSystemAdmin()) {
                    ...
                    if ((gtsHome != null) && gtsHome.isDirectory()) {
                        ...
                        double usedMb  = (double)gtsHome.getUsableSpace() / (1024.0 * 1024.0);
                        double totalMb = (double)gtsHome.getTotalSpace()  / (1024.0 * 1024.0);
