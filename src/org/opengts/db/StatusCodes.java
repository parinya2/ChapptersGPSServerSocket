...
// ----------------------------------------------------------------------------
    ...
    private static Code _codeArray[] = new Code[] {
        ...
        new Code(STATUS_LIGHTING_CHANGED    , "LIGHT_CHANGE" , I18N.getString(StatusCodes.class,"StatusCodes.lightingChanged" ,"Lighting Changed")       ), // (off) 
        new Code(STATUS_LIGHTING_BRIGHTER   , "LIGHT_BRIGHT" , I18N.getString(StatusCodes.class,"StatusCodes.lightingBright"  ,"Lighting Bright" )       ), // (off) 
        new Code(STATUS_LIGHTING_DARKER     , "LIGHT_DARK"   , I18N.getString(StatusCodes.class,"StatusCodes.lightingDark"    ,"Lighting Dark"   )       ), // (off) 
