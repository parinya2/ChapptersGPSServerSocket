    ...
    **/
    ...
    public byte[] getHandlePacket(byte pktBytes[]) 
    {
        ...
        if ((pktBytes != null) && (pktBytes.length > 0)) {
            ...
            Print.logInfo("BB Recv[TXT]: " + s); // debug message
            
            //GPSServer.writeMsgTologFile(s, ipAddress, clientPort);
            GPSServer.writeMsgToDatabase(s, ipAddress, clientPort);
