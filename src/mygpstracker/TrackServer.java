...
public class TrackServer
{
    ...
    public static void configInit()
    {
        ...
        if (dcs != null) {
            ...
            System.out.println("DCServer not found: " + Main.getServerName());
        }
    }
        ...
        throws Throwable
    {
            ...
            for (int i = 0; i < tcpPorts.length; i++) {
                ...
                if (ServerSocketThread.isValidPort(port)) {
                    try {
                        ...
                        System.out.println("TCP: Error binding to port: " + port);
                    }
                } else {
            ...
            for (int i = 0; i < udpPorts.length; i++) {
                ...
                if (ServerSocketThread.isValidPort(port)) {
                    try {
                        ...
                        System.out.println("UDP: Error binding to port: " + port);
                    }
                } else {
        ...
        if (listeners <= 0) {
            System.out.println("No active device communication listeners!");
        }
        ...
        if (commandPort > 0) {
            if (ServerSocketThread.isValidPort(commandPort)) {
                try {
                    ...
                    System.out.println("Command: Error binding to port: " + commandPort);
                }
            } else {
            ...
            System.out.println("Ignoring CommandPort listener");
        }
        ...
        throws Throwable
    {
        ...
        try {
            ...
            System.out.println("ServerSocket error" + t);
            throw t;
        }
    ...
    public ServerSocketThread getServerSocketThread_tcp(int port)
    {
        ...
        if (port <= 0) {
            ...
            if (sst != null) {
                ...
                System.out.println("TCP 'Listen' port["+port+"] not found, returning first ServerSocketThread");
                return this.tcpThread.getFirstValue();
            }
        }
    }
    ...
    public DatagramSocket getUdpDatagramSocket(int port)
    {
        ...
        if (port <= 0) {
            ...
            if (ds != null) {
                ...
                System.out.println("'Listen' port["+port+"] not found, returning first DatagramSocket");
                return this.udpSocket.getFirstValue();
            }
        }
    }
        ...
        throws Throwable
    {
        ...
        /* start thread */
        System.out.println("Starting Command listener thread on port " + port + " [timeout=" + sst.getSessionTimeout() + "ms] ...");
        sst.start();
        this.cmdThread = sst;
