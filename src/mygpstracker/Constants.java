...
public class Constants
{
    ...
    public static final String  COPYRIGHT               = "Chappters COPYTRIGHT";
    
    // ------------------------------------------------------------------------

    public static final String  DEVICE_CODE             = "Chappters DEVICE CODE";
    ...
    public static final long    TIMEOUT_TCP_IDLE        = 3000L;
    // After the 1st byte, the remainder of a packet must be read in this timeframe
    public static final long    TIMEOUT_TCP_PACKET      = 3000L;
    // The entire session must complete within this timeframe
    public static final long    TIMEOUT_TCP_SESSION     = 7000L;
    ...
    {
        System.out.println(VERSION); // OpenGTS
    }
